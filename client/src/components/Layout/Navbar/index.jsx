...
export default function Home() {
    ...
    return (
        <div>
            <div className="rounded-r bg-purple-900 xl:hidden flex justify-between w-full p-6 items-center ">
            ...
            <div id="Main" className={`${show ? 'translate-x-0' : '-translate-x-full'} xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-purple-900 flex-col`}>
                ...
                <div className="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
                    ...
                    <p className="text-2xl leading-6 text-white">BAM</p>
                    </button>
                </div>
                <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
                    ...
                    <div id="menu1" className={`${menu[0] ? 'flex' : 'hidden'} justify-start  flex-col w-full md:w-auto items-start pb-1 `}>
                        <a href="/transaction" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-purple-700 focus:text-white hover:bg-purple-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                            ...
                            <p className="text-base leading-4  ">Transaction</p>
                        </a>
                        <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-purple-700 focus:text-white hover:bg-purple-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="Account" className="flex justify-start items-center space-x-6 hover:text-white focus:bg-purple-700 focus:text-white hover:bg-purple-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p className="text-base leading-4  ">Accounts</p>
                        </a>
                    </div>
                </div>
                <div className="flex flex-col justify-between items-center h-full pb-6   px-6  w-full  space-y-32 ">
                    ...
                    <div className="hidden flex justify-start flex-col items-start pb-5 ">
                        <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-purple-700 focus:text-white hover:bg-purple-700 text-gray-400 rounded px-3 py-2  w-52">
                            <svg className="fill-stroke" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 10L11 14L17 20L21 4L3 11L7 13L9 19L12 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                    ...
                    <div className=" flex justify-between items-center w-full">
                        ...
                        <svg onClick={()=>logout()} className="cursor-pointer" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
